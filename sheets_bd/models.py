...
class Clients(models.Model):
    ...
    alfabank_status_inn = models.CharField(max_length=120, verbose_name='Статус ИНН Альфа', blank=True, default='')
    alfabank_comment = models.CharField(max_length=300, verbose_name='Коммент Альфа', blank=True, default='')
    alfabank_add_comment = models.CharField(max_length=300, verbose_name='Доп. коммент Альфа', null=True, blank=True)
    alfabank_str_comment = models.CharField(max_length=120, blank=True, default='')
    alfabank_send = models.BooleanField('Отправить РКО Альфа', default=False)
    alfabank_client_type = models.CharField(max_length=120, verbose_name='Тип клиента Альфа', blank=True, default='')
    alfabank_city = models.CharField(max_length=120, verbose_name='город банка Альфа', blank=True, default='')
    alfabank_response = models.TextField(verbose_name='Ответ банка Альфа', blank=True, default='')
    alfabank_fias = models.CharField(max_length=120, verbose_name='Fias Альфа', blank=True, default='')
    alfabank_ekvairing = models.CharField(max_length=120, blank=True, default='')
    alfabank_spec_schet_44 = models.CharField(max_length=120, blank=True, default='')
    alfabank_credit = models.CharField(max_length=120, blank=True, default='')
    ...
    open_status_inn = models.CharField(max_length=120, verbose_name='Статус ИНН Открытие', blank=True, default='')
    open_comment = models.CharField(max_length=300, verbose_name='Коммент Открытие', blank=True, default='')
    open_add_comment = models.CharField(max_length=300, verbose_name='Доп. коммент Открытие',
                                                   null=True, blank=True)
    open_send = models.BooleanField('Отправить Открытие', default=False)
    open_client_type = models.CharField(max_length=120, verbose_name='Тип клиента Открытие', blank=True, default='')
    open_city = models.CharField(max_length=120, verbose_name='Город банка Открытие', blank=True, default='')
    open_response = models.TextField(verbose_name='Ответ банка Открытие', blank=True, default='')
    open_ekvairing = models.BooleanField('Эквайринг Открытие', default=False)
